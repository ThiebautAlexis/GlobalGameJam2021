...
namespace EnhancedEditor.Editor
{
    ...
    public static class EditorGUIEnhanced
    {
        ...
        public static bool AssetPreviewField(Rect _position, SerializedProperty _property, GUIContent _label, bool _foldout)
        {
            ...
            if (!_texture)
            {
                ...
                if (_property.propertyType != SerializedPropertyType.ObjectReference)
                {
                    ...
                    EditorGUI.HelpBox(_position, "Asset Preview attribute can only be used with object reference type fields !", UnityEditor.MessageType.Error);
                }
                return false;
            }
        ...
        private static bool TryGetProgressBarMaxValue(Rect _position, SerializedProperty _property, string _maxValueVariableName, out float _maxValue)
        {
            ...
            EditorGUI.HelpBox(_position, $"Error : {_property.name} field | \"{_maxValueVariableName}\" value cannot be converted to single !", UnityEditor.MessageType.Error);
            return false;
        }
        ...
        private static bool TryGetProgressBarValue(Rect _position, SerializedProperty _property, out float _value)
        {
            ...
            EditorGUI.HelpBox(_position, $"Error : {_property.name} field | Progress bar cannot be used with \"{_property.propertyType}\" variable type !", UnityEditor.MessageType.Error);
            return false;
        }
        ...
        public static void RequiredProperty(Rect _position, SerializedProperty _property, GUIContent _label)
        {
            ...
            EditorGUI.HelpBox(_rect, "Keep in mind to set a reference to this field !", UnityEditor.MessageType.Error);
        }
        #endregion
