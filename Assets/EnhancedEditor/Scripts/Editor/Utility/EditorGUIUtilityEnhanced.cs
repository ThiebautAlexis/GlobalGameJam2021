...
namespace EnhancedEditor.Editor
{
    ...
    public static class EditorGUIUtilityEnhanced
    {
        ...
        /// <summary>
        /// Push a color to the GUI buffer and set <see cref="GUI.color"/> as it.
        /// </summary>
        /// <param name="_color">New GUI color.</param>
        public static void PushColor(Color _color)
        {
        ...
        /// <summary>
        /// Revert <see cref="GUI.color"/> to the GUI buffer previous one.
        /// </summary>
        public static void PopColor()
        {
            if (guiColors.Count > 0)
            {
                ...
                Debug.LogError("You are poping more color than you are pushing!");
        }
        #endregion
